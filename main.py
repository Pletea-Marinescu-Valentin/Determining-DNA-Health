...
# Defining function to calculate health of a sequence
...
# Creating a map of all subsequences of genes and their healths
...
# Finding the largest gene and calculating healths for all strands
